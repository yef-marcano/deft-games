...
class ModelosUsuarios{
        ...
        static public function update($tabla,$id,$datos){
            ...
            nombre=:nombre,apellidos=:apellidos,tipoDocumento=:tipoDocumento ,
            documento=:documento,fechaExpedicion=:fechaExpedicion,direccion=:direccion,celular=:celular        
            WHERE id=:id");
        ...
        static public function create($tabla,$datos){
            ...
            $stmt=Conexion::conectar()->prepare("INSERT INTO $tabla(email, pass, nombre, apellidos, tipoDocumento, documento, fechaExpedicion, direccion, celular)
             VALUES (:email,:pass,:nombre,:apellidos,:tipoDocumento,:documento,:fechaExpedicion,:direccion,:celular)");
